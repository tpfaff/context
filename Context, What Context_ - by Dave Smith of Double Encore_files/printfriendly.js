...
var pfCdnDomain = pfProtocol == 'https' ? 'https://web.archive.org/web/20130624074530/https://d1xyn5x24gwwys.cloudfront.net': 'https://web.archive.org/web/20130624074530/http://cdn.printnicer.com';
...
if(window.pfDebug) {
  pfCdnDomain = 'https://web.archive.org/web/20130624074530/http://cdn-local.printfriendly.com:3000';
  pfDomain = 'https://web.archive.org/web/20130624074530/http://local.printfriendly.com:3000';
  pfEmailDomain = 'https://web.archive.org/web/20130624074530/http://local.printfriendly.com:3000';
  pdfDomain = 'https://web.archive.org/web/20130624074530/http://pdf-local.printfriendly.com:3000';
  pfEnv = 'development';
  if(pfProtocol == 'https') {
    pfCdnDomain = pfDomain = pfEmailDomain = pdfDomain = 'https://web.archive.org/web/20130624074530/https://local.printfriendly.com';
  }
}
...
function pfinit() {
  ...
  priFri.bodyCache = '<div class="' + document.body.className + '">' + document.body.innerHTML + '</div>';
...
/*
     FILE ARCHIVED ON 07:45:30 Jun 24, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:02:52 May 14, 2021.
...
playback timings (ms):
  ...
  RedisCDXSource: 7.343
  esindex: 0.007
  LoadShardBlock: 548.571 (6)
  PetaboxLoader3.datanode: 388.836 (8)
  CDXLines.iter: 124.706 (3)
  load_resource: 398.875 (2)
  PetaboxLoader3.resolve: 250.193 (2)
*/